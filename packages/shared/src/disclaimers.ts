/**
 * MiCAR-compliance disclaimer texts.
 * Source of truth — referenced from web + marketing + api responses where applicable.
 * Wording is load-bearing for the "information service, not CASP" classification.
 */
...
export const TAX_ENGINE_DISCLAIMER_DE =
  'Diese Berechnung ist eine technische Hilfsleistung und ersetzt keine steuerliche Beratung. ' +
