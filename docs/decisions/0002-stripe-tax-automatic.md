...
CryptoTrader Pro sells subscriptions across the EU. EU MOSS (Mini One-Stop Shop) rules require collecting VAT at the buyer's country rate, filing quarterly returns, and emitting compliant invoices. Options:
...
**Re-evaluation trigger:** If CryptoTrader Pro grows past €1M ARR, revisit. At that scale the Tax fee becomes meaningful (~€5k/year) and we may bring it in-house.

**Tax residency:** OptiRisk e.U. is the Austrian entity in Phase 1. Stripe Tax registration uses that. When Phase 2 (CryptoTrader Pro GmbH) takes over, Stripe Tax registration migrates.
